export const medicosIniciales = [
  ...
  export const obrasSocialesIniciales = [
    { id: "101", nombre: "OSDE" },
    { id: "102", nombre: "OSPE" },
    { id: "103", nombre: "Swiss Medical" },
    { id: "104", nombre: "Medicus" },
    { id: "105", nombre: "Omint" },
    { id: "106", nombre: "Galeno" },
    { id: "107", nombre: "OSECAC" },
    { id: "108", nombre: "Sancor Salud" },
    { id: "109", nombre: "Accord Salud" },
    { id: "110", nombre: "Federada Salud" },
    { id: "111", nombre: "IOMA" }
  ];